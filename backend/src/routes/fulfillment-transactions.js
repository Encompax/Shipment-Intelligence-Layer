...
const tenant_config_1 = require("../config/tenant-config");
// Mock data representing real fulfillment workflow
const generateMockFulfillmentOrders = () => {
    var _a, _b, _c, _d, _e, _f;
    const { customers, items, operators, locations } = (0, tenant_config_1.getTenantConfig)();
    ...
    const orders = [
        ...
        },
        {
            ...
            line_items: [
                {
                    line_number: 1,
                    item_number: ((_a = resolvedItems[1]) === null || _a === void 0 ? void 0 : _a.sku) || resolvedItems[0].sku,
                    item_description: ((_b = resolvedItems[1]) === null || _b === void 0 ? void 0 : _b.description) || resolvedItems[0].description,
        ...
        },
        {
            ...
            line_items: [
                {
                    line_number: 1,
                    item_number: ((_c = resolvedItems[2]) === null || _c === void 0 ? void 0 : _c.sku) || resolvedItems[0].sku,
                    item_description: ((_d = resolvedItems[2]) === null || _d === void 0 ? void 0 : _d.description) || resolvedItems[0].description,
        ...
        },
        {
            ...
            line_items: [
                {
                    line_number: 1,
                    item_number: ((_e = resolvedItems[3]) === null || _e === void 0 ? void 0 : _e.sku) || resolvedItems[0].sku,
                    item_description: ((_f = resolvedItems[3]) === null || _f === void 0 ? void 0 : _f.description) || resolvedItems[0].description,
...
function registerFulfillmentRoutes(app) {
    ...
    router.get("/orders", async (req, res) => {
        try {
            const filterStatus = req.query.status; // pending, picked, verified
    ...
    router.post("/orders/:sales_order_number/pick", async (req, res) => {
        try {
            ...
            const lineItem = await prisma_1.prisma.orderLineItem.upsert({
            ...
            const pickingTransaction = await prisma_1.prisma.pickingTransaction.create({
                data: {
    ...
    router.post("/orders/:sales_order_number/verify", async (req, res) => {
        try {
            const { sales_order_number } = req.params;
            ...
            const verificationTransaction = await prisma_1.prisma.verificationTransaction.create({
                data: {
                    line_item_id: lineItem.id,
                    sales_order_number,
                    quantity_verified,
