...
export const lanes: SilLaneProfile[] = [
  {
...
export const carriers: SilCarrierProfile[] = [
  {
...
export const shipments: SilShipment[] = [
  {
    ...
    stops: [
      {
        ...
        sequence: 1,
        type: "PICKUP",
        location: loads[0].origin,
        appointmentStart: loads[0].pickupWindowStart,
        appointmentEnd: loads[0].pickupWindowEnd,
        status: "PENDING",
      },
      {
        ...
        sequence: 2,
        type: "DELIVERY",
        location: loads[0].destination,
        appointmentStart: loads[0].deliveryWindowStart,
        appointmentEnd: loads[0].deliveryWindowEnd,
        status: "PENDING",
      },
    ],
    cost: 2650,
...
export const postings: SilLoadPosting[] = [
  {
...
export const marketRates: SilMarketRateObservation[] = [
  {
...
export function getGovernanceSignals(): SilGovernanceSignalDraft[] {
  return [
    {
